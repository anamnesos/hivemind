...
describe('github-service (Phase 1)', () => {
  ...
  test('getRepo returns normalized repository metadata', async () => {
    ...
    resolveExec(JSON.stringify({
      name: 'squidrun',
      nameWithOwner: 'acme/squidrun',
      owner: { login: 'acme' },
      defaultBranchRef: { name: 'main' },
      url: 'https://github.com/acme/squidrun',
    }));
    ...
    resolveExec(JSON.stringify([
      {
        ...
        state: 'OPEN',
        isDraft: false,
        url: 'https://github.com/acme/squidrun/pull/42',
  ...
  test('getPR returns normalized PR details', async () => {
    ...
    resolveExec(JSON.stringify({
      ...
      state: 'OPEN',
      isDraft: true,
      url: 'https://github.com/acme/squidrun/pull/99',
  ...
  test('createPR returns fetched PR when gh supports --json', async () => {
    ...
    resolveExec(JSON.stringify({ number: 7, url: 'https://github.com/acme/squidrun/pull/7' }));
    resolveExec(JSON.stringify({
      number: 7,
      ...
      state: 'OPEN',
      isDraft: false,
      url: 'https://github.com/acme/squidrun/pull/7',
  ...
  test('buildPRBody includes session context, commit summary, tests, and transition stats', async () => {
    ...
    expect(body).toContain('🤖 Generated by SquidRun Architect');
  });
  ...
  test('createPR auto-generates body when body is not provided', async () => {
    ...
    resolveExec(JSON.stringify({ number: 23, url: 'https://github.com/acme/squidrun/pull/23' }));
    resolveExec(JSON.stringify({
      number: 23,
      title: 'Auto body PR',
      body: 'generated',
      state: 'OPEN',
      isDraft: false,
      url: 'https://github.com/acme/squidrun/pull/23',
  ...
  test('createPR uses explicit body as-is and skips auto generation', async () => {
    ...
    resolveExec(JSON.stringify({ number: 24, url: 'https://github.com/acme/squidrun/pull/24' }));
    resolveExec(JSON.stringify({
      number: 24,
      ...
      state: 'OPEN',
      isDraft: false,
      url: 'https://github.com/acme/squidrun/pull/24',
  ...
  test('updatePR edits metadata and closes PR when requested', async () => {
    ...
    resolveExec(JSON.stringify({
      ...
      state: 'CLOSED',
      isDraft: false,
      url: 'https://github.com/acme/squidrun/pull/15',
    ...
    resolveExec(JSON.stringify([
      {
        ...
        body: 'Details',
        state: 'OPEN',
        url: 'https://github.com/acme/squidrun/issues/12',
    ...
    expect(issues).toEqual([
      {
        ...
        state: 'OPEN',
        url: 'https://github.com/acme/squidrun/issues/12',
        html_url: 'https://github.com/acme/squidrun/issues/12',
        author: 'architect',
  ...
  test('getIssue returns normalized issue details', async () => {
    ...
    resolveExec(JSON.stringify({
      ...
      body: 'Body',
      state: 'OPEN',
      url: 'https://github.com/acme/squidrun/issues/33',
      labels: [{ name: 'docs' }],
  ...
  test('createIssue creates and returns issue details', async () => {
    const service = createGitHubService();
    resolveExec(JSON.stringify({ number: 88, url: 'https://github.com/acme/squidrun/issues/88' }));
    resolveExec(JSON.stringify({
      number: 88,
      title: 'New issue',
      body: 'Need fix',
      state: 'OPEN',
      url: 'https://github.com/acme/squidrun/issues/88',
      labels: [{ name: 'bug' }],
      assignees: [{ login: 'builder' }],
      author: { login: 'architect' },
    }));
  ...
  test('closeIssue closes and fetches latest issue state', async () => {
    ...
    resolveExec(JSON.stringify({
      ...
      body: '',
      state: 'CLOSED',
      url: 'https://github.com/acme/squidrun/issues/10',
      labels: [],
      assignees: [],
      author: { login: 'builder' },
    }));
  ...
  test('addIssueComment returns comment metadata', async () => {
    ...
    resolveExec(JSON.stringify({
      id: 'c_123',
      url: 'https://github.com/acme/squidrun/issues/12#issuecomment-123',
    }));
      ...
      check_runs: [
        {
          ...
          status: 'completed',
          conclusion: 'success',
          html_url: 'https://github.com/acme/squidrun/actions/runs/1',
        },
      ],
    }));
    ...
    expect(checks).toEqual([
      {
        ...
        status: 'completed',
        conclusion: 'success',
        url: 'https://github.com/acme/squidrun/actions/runs/1',
      },
    ]);
    expect(execFile).toHaveBeenNthCalledWith(
      2,
      'gh',
      ['api', 'repos/acme/squidrun/commits/HEAD/check-runs'],
      expect.any(Object),
      expect.any(Function)
    );
  });
    ...
    resolveExec(JSON.stringify([
      {
        ...
        status: 'completed',
        conclusion: 'success',
        url: 'https://github.com/acme/squidrun/actions/runs/777',
        headBranch: 'main',
        headSha: 'abc123',
        event: 'push',
