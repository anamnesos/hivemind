  ...
  _insertBinding(db, assertionId, incidentId, binding, opts = {}) {
    ...
    try {
      ...
      `).run(
        ...
        (binding.logStartMs !== null && binding.logStartMs !== undefined && Number.isFinite(Number(binding.logStartMs))) ? Number(binding.logStartMs) : null,
        (binding.logEndMs !== null && binding.logEndMs !== undefined && Number.isFinite(Number(binding.logEndMs))) ? Number(binding.logEndMs) : null,
