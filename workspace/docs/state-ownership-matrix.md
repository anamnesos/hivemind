...
| Project bootstrap link | `link.json` | Project | `ui/modules/ipc/project-handlers.js` (`writeProjectBootstrapFiles`) | `ui/scripts/hm-send.js` (`resolveProjectContextFromLink`) | Defines `squidrun_root`, `workspace`, `session_id`, role targets. |
